...
function render(employees, teamName){
  ...
  return renderAll(engineerArr, internArr, managerArr, teamName).replace(/","/g,"");
...
function renderAll(engineerArr, internArr, managerArr, teamPassed){
    ...
    template = replacePlaceholders(template, "engineers", engineerArr).replace(/","/g,"");
    template = replacePlaceholders(template, "interns", internArr).replace(/","/g,"");
    template = replacePlaceholders(template, "teamName", teamPassed).replace(/","/g,"");
    return template;
  };
